...
const Users: React.FC = () => {
  ...
  <thead>
    <tr className="bg-primary text-left">
      <th
        className="sticky top-0 px-5 py-3 border-b-2 border-gray-200 text-sm font-semibold bg-primary z-10"
      >
        ID
      </th>
      <th
        ...
        Actions
                  ...
                  <tr key={user.userId} className="hover:bg-gray-100">
                    ...
                    <td className="px-5 py-3 border-b border-gray-200 text-sm">
                      <img
                        src={
                          user.studentProfile
                            ? `http://localhost:8080/images/${user.userId}`
                            : "/default-studentProfile.png"
                        }
                    ...
                    <td className="px-5 py-3 border-b border-gray-200 text-sm">
                      ...
                      <button
                        ...
                        onClick={() =>
                          alert(
                            `Update user: ${user.username} and ${user.userId}`
                          )
                        }
                      >
                        Update
          ...
          <div className="text-right mb-4 mr-52 mt-4">
              <a
                ...
                shadow-md hover:bg-button-hover transition duration-300 "
              >
                Add New User
              </a>
            </div>
