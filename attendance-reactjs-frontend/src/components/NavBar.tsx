...
import { FaHome, FaUser, FaInfoCircle, FaServicestack, FaPhone } from 'react-icons/fa';
  ...
  return (
    <nav className="bg-secondary p-4 border border-secondary flex items-center justify-between sticky top-0 z-50 pb-4">
      ...
      <ul className="flex space-x-6 ">
        <li>
          <a href="#home" className="flex items-center text-primary text-base hover:text-blue-500">
            <FaHome className="mr-2 text-blue-600" />
            Home
          </a>
        </li>
        <li>
          <a href="#register" className="flex items-center text-primary text-base hover:text-blue-500">
            <FaUser className="mr-2 text-blue-600" />
            Register/Login
          </a>
        </li>
        <li>
          <a href="#about" className="flex items-center text-primary text-base hover:text-blue-500">
            <FaInfoCircle className="mr-2 text-blue-600" />
            About
          </a>
        </li>
        <li>
          <a href="#services" className="flex items-center text-primary text-base hover:text-blue-500">
            <FaServicestack className="mr-2 text-blue-600"  />
            Services
          </a>
        </li>
        <li>
          <a href="#contact" className="flex items-center text-primary text-base hover:text-blue-500">
